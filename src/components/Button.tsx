...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: "bg-gray-100 hover:bg-gray-200 dark:bg-zinc-700 dark:hover:bg-zinc-600 text-gray-700 dark:text-zinc-200 focus:ring-gray-400",
    danger: "bg-red-50 hover:bg-red-100 dark:bg-red-900/40 dark:hover:bg-red-900/60 text-red-600 dark:text-red-400 focus:ring-red-400",
    ghost: "bg-transparent hover:bg-gray-100/50 dark:hover:bg-white/10 text-gray-600 dark:text-zinc-300",
