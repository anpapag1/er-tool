...
| Physics | Multi-Select | Export |
|-------------|---------------|--------|
| ![Auto-layout demo](public/readme/physics.gif) | ![Share URL demo](public/readme/multi_select.gif) | ![Export demo](public/readme/export.gif) |
| Physics untangles the diagram automaticaly | Paste the URL — recipient gets the full diagram | PNG, SVG, PDF, or JSON in one click |
